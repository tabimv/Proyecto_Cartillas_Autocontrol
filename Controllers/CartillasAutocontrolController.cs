    ...
    public class CartillasAutocontrolController : Controller
    {
        ...
        public async Task<ActionResult> ListaCartillasPorActividad()
        {
            if (Session["UsuarioAutenticado"] != null)
            {
                ...
                var detalleCartillas = db.DETALLE_CARTILLA.Include(d => d.ITEM_VERIF).Include(d => d.CARTILLA)
        ...
        public async Task<ActionResult> Edit([Bind(Include = "detalle_cartilla_id,estado_autocontrol,estado_ito,ITEM_VERIF_item_verif_id,ACTIVIDAD_actividad_id,CARTILLA_cartilla_id,INMUEBLE_inmueble_id, CARTILLA")] DETALLE_CARTILLA detalleCartilla)
        {
        ...
        public async Task<ActionResult> LoteDetails(int cartillaId)
        {
            ...
            var items = await db.LOTE_INMUEBLE
                .Where(a => a.OBRA_obra_id == obraSeleccionada.obra_id)
                .ToListAsync();
